...
.mdc-toolbar--flexible {
  ...
  .mdc-toolbar--flexible-default-behavior .mdc-toolbar__title {
    ...
    -webkit-transform: translateY(calc(64px * (var(--mdc-toolbar-ratio-to-extend-flexible, 4) - 1)));
    ...
    @media (max-width: 599px) {
      .mdc-toolbar--flexible-default-behavior .mdc-toolbar__title {
        ...
        -webkit-transform: translateY(calc(56px * (var(--mdc-toolbar-ratio-to-extend-flexible, 4) - 1)));
