/*
Error: File to import not found or unreadable: @material/animation/variables.
        on line 15 of mdc-switch.scss
...
14: 
15: @import "@material/animation/variables";
16: @import "@material/elevation/mixins";
17: @import "@material/theme/mixins";
18: @import "./variables";
19: 
20: @function mdc-switch-transition($property) {
...
body:before {
  ...
  content: "Error: File to import not found or unreadable: @material/animation/variables.\A         on line 15 of mdc-switch.scss\A \A 10: // distributed under the License is distributed on an \"AS IS\" BASIS,\A 11: // WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\A 12: // See the License for the specific language governing permissions and\A 13: // limitations under the License.\A 14: \A 15: @import \"@material/animation/variables\";\A 16: @import \"@material/elevation/mixins\";\A 17: @import \"@material/theme/mixins\";\A 18: @import \"./variables\";\A 19: \A 20: @function mdc-switch-transition($property) {"; }
