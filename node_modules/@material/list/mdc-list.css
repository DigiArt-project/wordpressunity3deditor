/*
Error: File to import not found or unreadable: @material/ripple/mixins.
        on line 15 of mdc-list.scss
...
14: 
15: @import "@material/ripple/mixins";
16: @import "@material/rtl/mixins";
17: @import "@material/theme/mixins";
18: @import "@material/typography/mixins";
19: @import "@material/typography/variables";
20: 
...
C:/Ruby23-x64/lib/ruby/gems/2.3.0/gems/sass-3.4.23/lib/sass/plugin.rb:82:in `update_stylesheets'
C:/Ruby23-x64/lib/ruby/gems/2.3.0/gems/sass-3.4.23/lib/sass/exec/sass_scss.rb:340:in `watch_or_update'
...
C:/Ruby23-x64/lib/ruby/gems/2.3.0/gems/sass-3.4.23/bin/scss:13:in `<top (required)>'
C:/Ruby23-x64/bin/scss:22:in `load'
C:/Ruby23-x64/bin/scss:22:in `<main>'
*/
body:before {
  white-space: pre;
  font-family: monospace;
  content: "Error: File to import not found or unreadable: @material/ripple/mixins.\A         on line 15 of mdc-list.scss\A \A 10: // distributed under the License is distributed on an \"AS IS\" BASIS,\A 11: // WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\A 12: // See the License for the specific language governing permissions and\A 13: // limitations under the License.\A 14: \A 15: @import \"@material/ripple/mixins\";\A 16: @import \"@material/rtl/mixins\";\A 17: @import \"@material/theme/mixins\";\A 18: @import \"@material/typography/mixins\";\A 19: @import \"@material/typography/variables\";\A 20: "; }
