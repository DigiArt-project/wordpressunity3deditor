...
Error: File to import not found or unreadable: @material/animation/variables.
        on line 17 of _variables.scss
        from line 17 of _mixins.scss
        from line 17 of mdc-elevation.scss
...
17: @import "./mixins";
18: 
19: @for $z-value from 0 through 24 {
20:   .mdc-elevation--z#{$z-value} {
21:     @include mdc-elevation($z-value);
22:   }

Backtrace:
_variables.scss:17
_mixins.scss:17
mdc-elevation.scss:17
...
body:before {
  ...
  content: "Error: File to import not found or unreadable: @material/animation/variables.\A         on line 17 of _variables.scss\A         from line 17 of _mixins.scss\A         from line 17 of mdc-elevation.scss\A \A 12: // WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\A 13: // See the License for the specific language governing permissions and\A 14: // limitations under the License.\A 15: //\A 16: \A 17: @import \"./mixins\";\A 18: \A 19: @for $z-value from 0 through 24 {\A 20:   .mdc-elevation--z#{$z-value} {\A 21:     @include mdc-elevation($z-value);\A 22:   }"; }
