...
19: @import "@material/theme/mixins";
20: @import "@material/rtl/mixins";
21: 
22: @mixin mdc-select-dd-arrow-svg-bg_($fill-hex-number: 000000, $opacity: .54) {
...
body:before {
  ...
  content: "Error: File to import not found or unreadable: @material/animation/functions.\A         on line 17 of mdc-select.scss\A \A 12: // WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\A 13: // See the License for the specific language governing permissions and\A 14: // limitations under the License.\A 15: //\A 16: \A 17: @import \"@material/animation/functions\";\A 18: @import \"@material/typography/mixins\";\A 19: @import \"@material/theme/mixins\";\A 20: @import \"@material/rtl/mixins\";\A 21: \A 22: @mixin mdc-select-dd-arrow-svg-bg_($fill-hex-number: 000000, $opacity: .54) {"; }
