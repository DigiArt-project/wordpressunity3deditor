...
global $ini_scene_chem_exam,$ini_scene_chem_microworld;
...
$ini_scene_chem_microworld = array('ADD HERE');
...
function wpunity_default_value_microworld_unity_chemistry_get(){
  global $ini_scene_chem_microworld;
  return $ini_scene_chem_microworld[0];
}
