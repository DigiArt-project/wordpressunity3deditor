...
function wpunity_getSceneYAML_archaeology($myscene_type){
    ...
    if($myscene_type == 'menu') {
        ...
        $def_json = file_get_contents(WP_PLUGIN_DIR . "/wordpressunity3deditor/includes/default_game_project_data/archaeology/scenes/archaeology-exam2d.txt");
    }elseif($myscene_type == 'exam3d'){
        $def_json = file_get_contents(WP_PLUGIN_DIR . "/wordpressunity3deditor/includes/default_game_project_data/archaeology/scenes/archaeology-exam3d.txt");
    }
...
add_action('create_wpunity_scene_yaml', 'wpunity_scenes_types_archaeology_fields_cre');

function wpunity_scenes_types_archaeology_fields_cre($term_id){
