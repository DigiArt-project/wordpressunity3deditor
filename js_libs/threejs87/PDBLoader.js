...
THREE.PDBLoader.prototype = {
    ...
    parse: function ( text ) {
        ...
        function parseBond( start, length, satom, lines, bhash, i ) {
        ...
        for ( var i = 0, l = lines.length; i < l; i ++ ) {
            ...
            if ( lines[ i ].substr( 0, 4 ) === 'ATOM' || lines[ i ].substr( 0, 6 ) === 'HETATM' ) {
                ...
                parseBond( 11, 5, satom, lines, bhash, i );
                parseBond( 16, 5, satom, lines, bhash, i );
                parseBond( 21, 5, satom, lines, bhash, i );
                parseBond( 26, 5, satom, lines, bhash, i );
